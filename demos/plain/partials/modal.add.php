<div id="modal-add" class="modal-window fixed pin z-50 overflow-auto bg-black top-0 left-0 w-screen h-screen bg-opacity-25 flex">
      ...
      <div class="bg-white border border-gray-200 shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-8">
          ...
          <div class="mb-4">
            ...
            <input autofocus class="appearance-none shadow-inner block w-full bg-gray-200 text-gray-700 border border-gray-300 rounded py-3 px-2 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="name" name="name" type="text">
          </div>
        </div>
